...
import { formaReleaseDate } from '../utils/dateFunctions.js';
...
const WatchPage = () => {
    const { id } = useParams(); ///id in params
    ...
    return (
        <div className='bg-black min-h-screen text-white'>
            <div
                className='mx-auto container px-4 py-8 h-full'>
                <Navbar />
                ...
                max-w-6xl mx-auto '>
                    ...
                    <img src={ORIGINAL_IMG_BASE_URL + content?.poster_path} alt="poster image"
                        className='max-h-[600px] ronded-md '
                    />

                </div>

                {similarContent.length > 0 && (
                    <div className='mt-12 ma-w-5xl mx-uto relative'>
