...
function AuthScreen() {
   ...
   const handleFormSubmit = (e) =>{
    e.preventDefault()
    navigate("/signup?email=" + email) /// email in url browser 
   };
    ...
    return (
      ...
      max-w-6xl mx-auto">
                ...
                <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
                    ...
                    />
                    <button className="bg-red-600 text-xl lg:text-2xl px-2 py-1 md:py-2 rounded 
          flex justify-center items-center">
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-lg md:text-xl">
                            Watch on Smart TVs, PlayStation, ChromeCast, Apple TV, Blu-ray players, and more.
                        </p>
                    </div>
            ...
            <div className="py-10 bg-black text-white ">
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4
                    md:px-2">
